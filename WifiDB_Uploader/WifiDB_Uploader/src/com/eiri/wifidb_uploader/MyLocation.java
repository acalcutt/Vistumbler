...
class MyLocation{
         ...
         public void run() {
            ...
            if(bestLocation == null && gps_enabled){
                ...
                if(stop == false && !needToStop()){
                	Log.d(TAG, "Connected " + sat_count + " sattelites. continue waiting..");
                    handler.postDelayed(this, iteration_timeout_step);
                }else{
                	Log.d(TAG, "#########################################");
                	Log.d(TAG, "BestLocation finded return result to main. sat_count=" + sat_count);
                	Log.d(TAG, "#########################################");
    ...
    public void destroy(Context ctx, LocationResult result){
        context = ctx;
        locationResult = result;
