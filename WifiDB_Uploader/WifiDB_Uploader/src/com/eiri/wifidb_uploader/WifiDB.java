...
public class WifiDB {
	...
	public void postLiveData(String sSID, String bSSID, String capabilities, Integer frequency, Integer level, Double latitude_str, Double longitude_str) {
        ...
        nameValuePairs.add(new BasicNameValuePair("latitude", Double.toString(latitude_str)));
        nameValuePairs.add(new BasicNameValuePair("longitude", Double.toString(longitude_str)));
