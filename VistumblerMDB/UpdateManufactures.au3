...
Dim $TmpManuDB_OBJ
Dim $TmpManuDB = _TempFile($TmpDir, "manudb-tmp_", ".mdb")
Dim $ManufMacEXE = $TmpDir & "\manufmac.exe" ;Phils PHP script to create manufactures.ini based on ieee.org oui.txt
Dim $ManuINI = $TmpDir & "\manufactures.ini" ;Vistumbler Manufacturer ini file (generated by manufmac.exe)
Dim $ManuINCPHP = $TmpDir & "\manufactures.inc.php" ;WiFiDB Manufacturer file (generated by manufmac.exe)
Dim $ManuDB = @ScriptDir & "\Settings\" & "Manufacturers.mdb"

;Copy Phil's manufacturer script to temp dir
FileInstall("manufmac.exe", $TmpDir, 1)
