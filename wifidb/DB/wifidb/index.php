...
if($func == "index")
{
	...
	if (!isset($usercount)){$lastuser['username'] = "No one has imported any APs yet."; $usercount = 0; $lastuser['title'] = "No Imports yet";}
	?>
	</td>
	...
	<table WIDTH=85% BORDER=1 CELLPADDING=2 CELLSPACING=0>
		...
		<tr>
			...
			<td align="center" class="style2"><a class="links" href="opt/userstats.php?func=useraplist&row=<?php echo $row_users;?>"><?php echo $lastuser['title'];?></a></td>
		</tr>
	</table>
	<?php
}elseif($func == "announce")
{
	pageheader("Announcement's Page");
}else
{
	pageheader("ERROR");
