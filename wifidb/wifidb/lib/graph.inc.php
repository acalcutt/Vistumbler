	...
	echo "Built array of AP ID's<br>";
		...
		echo "Connected to Wifi_ST<br>";
			...
			if (file_exists($file_v) and file_exists($file_b))
			{
				...
				$this->wifigraphline($this->ssid, $this->mac, $this->man, $this->auth, $this->encry, $this->radio, $this->chan, $lat[$n], $long[$n], $btx[$n], $otx[$n], $fa[$n], $lu[$n], $nt[$n], $label[$n], $sig[$n], $source_row );
				echo "Generated Line Graph<br>";
				}
				if(!file_exists($file_b)){
				$this->wifigraphbar($this->ssid, $this->mac, $this->man, $this->auth, $this->encry, $this->radio, $this->chan, $lat[$n], $long[$n], $btx[$n], $otx[$n], $fa[$n], $lu[$n], $nt[$n], $label[$n], $sig[$n], $source_row );
...
#==============================================================================================================================================================#
	...
	function wifigraphline($ssid, $mac, $man, $auth, $encry, $radio, $chan, $lat, $long, $BTx, $OTx, $FA, $LU, $NT, $label, $sig, $date, $bgc, $linec="rand", $text="rand", $verbose=1)
	{
            $n=0;
            $nn=1;
            $y=20;
	...
	#													WiFi Graph Bargraph													         #
	#==============================================================================================================================================================#
	function wifigraphbar($ssid, $mac, $man, $auth, $encry, $radio, $chan, $lat, $long, $BTx, $OTx, $FA, $LU, $NT, $label, $sig, $date, $bgc, $linec="rand", $text="rand", $verbose=1)
	{
            $p=460;
            $I=0;
